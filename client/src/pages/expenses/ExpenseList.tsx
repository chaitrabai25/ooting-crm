...
import { Plus, Receipt, Download, Search, Filter } from 'lucide-react';
...
export const ExpenseList: React.FC = () => {
  ...
  const columns: Column<Expense>[] = [
    ...
    {
      header: 'Description',
      render: (e) => <span className="text-xs text-slate-700">{e.description}</span>,
    },
    {
    ...
    {
      header: 'Recorded By',
      render: (e) => <span className="text-xs text-slate-500">{e.createdBy?.name || 'Staff'}</span>,
    },
    {
      header: 'Amount',
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
          <h1 className="text-xl font-bold tracking-tight text-slate-900">Expense Management</h1>
